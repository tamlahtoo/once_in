...
<html lang="en">
<head>
<title>Events Venue a Wedding Category Bootstrap responsive Website Template | Gallery :: w3layouts</title>
			...
			<div class="gallery-grids-row">
				<div class="col-md-4 gallery-grid">
					<div class="wpf-demo-4">  
						<a href="images/r.jpg" class="jzBoxLink item-hover" title="Events Venue">  
