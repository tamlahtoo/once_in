...
<body>
	...
	<div class="main-textgrids">
		<div class="container">
			...
			<div class="col-md-7 ab-text">
				<h4 style="font-size: 250%;text-align: center;" class="ab_h">Where wedding businesses grow</h4>
				<p style="font-size: 120%;text-align: center;color: gray">We help wedding professionals reach more engaged local couples, book more weddings and drive success to their businesses.
			...
			<div class="statements">
				<div class="col-md-7 mission">
					 <h4 style="font-size: 250%;text-align: center;">Wedding planning starts here</h4>
					 <p style="font-size: 120%;text-align: center;color: gray;">We help couples discover vendors and ideas and provide them with online tools to help them create their ideal wedding day.</p>
	...
	<div class="jarallax different">
		<div class="container">
			<div class="w3-agileits-heading different-heading">
